...
/**
 * Barcode Compliance Report - QR lifecycle tracking.
 * Tracks: generated, used, verified, unverified, delayed, duplicates.
 */
@Entity
@Table(name = "barcode_compliance_report")
public class BarcodeComplianceReport {
