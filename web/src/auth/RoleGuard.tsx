...
export const TOP_MANAGEMENT_ADMIN_ONLY: UserRole[] = ['TOP_MANAGEMENT_ADMIN'];
export const ADMIN_ROLES: UserRole[] = ['SUPER_ADMIN', 'CBWTF_ADMIN'];
export const ALL_ADMIN_ROLES: UserRole[] = ['SUPER_ADMIN', 'CBWTF_ADMIN', 'HCF_ADMIN', 'TOP_MANAGEMENT_ADMIN'];
