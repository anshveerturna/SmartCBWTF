...
public abstract interface BagEventDao {
    ...
    @androidx.room.Query(value = "UPDATE bag_events SET synced = 1 WHERE qrCode IN (:qrCodes)")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object markSyncedByQrCodes(@org.jetbrains.annotations.NotNull()
    java.util.List<java.lang.String> qrCodes, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
