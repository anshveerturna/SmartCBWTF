...
public abstract class Hilt_QrScannerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QrScannerFragment() {
    super();
  }

  Hilt_QrScannerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QrScannerFragment_GeneratedInjector) this.generatedComponent()).injectQrScannerFragment(UnsafeCasts.<QrScannerFragment>unsafeCast(this));
    }
  }
