...
public abstract class Hilt_VerifyAtCbtwfFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerifyAtCbtwfFragment() {
    super();
  }

  Hilt_VerifyAtCbtwfFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerifyAtCbtwfFragment_GeneratedInjector) this.generatedComponent()).injectVerifyAtCbtwfFragment(UnsafeCasts.<VerifyAtCbtwfFragment>unsafeCast(this));
    }
  }
