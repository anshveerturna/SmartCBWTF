...
public abstract class Hilt_ScanWeighFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ScanWeighFragment() {
    super();
  }

  Hilt_ScanWeighFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScanWeighFragment_GeneratedInjector) this.generatedComponent()).injectScanWeighFragment(UnsafeCasts.<ScanWeighFragment>unsafeCast(this));
    }
  }
