...
public abstract class Hilt_ChangePasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangePasswordFragment() {
    super();
  }

  Hilt_ChangePasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangePasswordFragment_GeneratedInjector) this.generatedComponent()).injectChangePasswordFragment(UnsafeCasts.<ChangePasswordFragment>unsafeCast(this));
    }
  }
