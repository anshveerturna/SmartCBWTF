...
public abstract class Hilt_StartPickupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StartPickupFragment() {
    super();
  }

  Hilt_StartPickupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartPickupFragment_GeneratedInjector) this.generatedComponent()).injectStartPickupFragment(UnsafeCasts.<StartPickupFragment>unsafeCast(this));
    }
  }
