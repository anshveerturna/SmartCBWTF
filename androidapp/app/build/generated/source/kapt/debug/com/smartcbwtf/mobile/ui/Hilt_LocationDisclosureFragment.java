...
public abstract class Hilt_LocationDisclosureFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LocationDisclosureFragment() {
    super();
  }

  Hilt_LocationDisclosureFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LocationDisclosureFragment_GeneratedInjector) this.generatedComponent()).injectLocationDisclosureFragment(UnsafeCasts.<LocationDisclosureFragment>unsafeCast(this));
    }
  }
