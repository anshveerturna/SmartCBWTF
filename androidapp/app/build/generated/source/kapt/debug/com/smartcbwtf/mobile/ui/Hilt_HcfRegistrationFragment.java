...
public abstract class Hilt_HcfRegistrationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HcfRegistrationFragment() {
    super();
  }

  Hilt_HcfRegistrationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HcfRegistrationFragment_GeneratedInjector) this.generatedComponent()).injectHcfRegistrationFragment(UnsafeCasts.<HcfRegistrationFragment>unsafeCast(this));
    }
  }
