...
public abstract class Hilt_MyRouteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyRouteFragment() {
    super();
  }

  Hilt_MyRouteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyRouteFragment_GeneratedInjector) this.generatedComponent()).injectMyRouteFragment(UnsafeCasts.<MyRouteFragment>unsafeCast(this));
    }
  }
