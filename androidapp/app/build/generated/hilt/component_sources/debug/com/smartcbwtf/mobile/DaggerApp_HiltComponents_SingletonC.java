...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(6).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_HcfRegistrationViewModel, HcfRegistrationViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_ScanWeighViewModel, ScanWeighViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_StartPickupViewModel, StartPickupViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_VerifyAtPlantViewModel, VerifyAtPlantViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.hcfRegistrationViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.homeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.scanWeighViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
      this.startPickupViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
      this.verifyAtPlantViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 5);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(6).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_AuthViewModel, ((Provider) authViewModelProvider)).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_HcfRegistrationViewModel, ((Provider) hcfRegistrationViewModelProvider)).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_HomeViewModel, ((Provider) homeViewModelProvider)).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_ScanWeighViewModel, ((Provider) scanWeighViewModelProvider)).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_StartPickupViewModel, ((Provider) startPickupViewModelProvider)).put(LazyClassKeyProvider.com_smartcbwtf_mobile_viewmodel_VerifyAtPlantViewModel, ((Provider) verifyAtPlantViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.smartcbwtf.mobile.viewmodel.AuthViewModel 
          return (T) new AuthViewModel(singletonCImpl.defaultAuthRepositoryProvider.get());

          case 1: // com.smartcbwtf.mobile.viewmodel.HcfRegistrationViewModel 
          return (T) new HcfRegistrationViewModel(singletonCImpl.defaultHcfRepositoryProvider.get(), singletonCImpl.locationHelperProvider.get());

          case 2: // com.smartcbwtf.mobile.viewmodel.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.defaultAuthRepositoryProvider.get(), singletonCImpl.defaultBagEventRepositoryProvider.get());

          case 3: // com.smartcbwtf.mobile.viewmodel.ScanWeighViewModel 
          return (T) new ScanWeighViewModel(singletonCImpl.provideScaleServiceProvider.get(), singletonCImpl.defaultBagEventRepositoryProvider.get(), singletonCImpl.locationHelperProvider.get());

          case 4: // com.smartcbwtf.mobile.viewmodel.StartPickupViewModel 
          ...
          case 5: // com.smartcbwtf.mobile.viewmodel.VerifyAtPlantViewModel 
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.defaultAuthTokenStoreProvider = DoubleCheck.provider(new SwitchingProvider<DefaultAuthTokenStore>(singletonCImpl, 7));
      ...
      this.permissionHelperProvider = DoubleCheck.provider(new SwitchingProvider<PermissionHelper>(singletonCImpl, 11));
      ...
      this.provideHcfApiProvider = DoubleCheck.provider(new SwitchingProvider<HcfApi>(singletonCImpl, 15));
      this.defaultHcfRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<DefaultHcfRepository>(singletonCImpl, 14));
      this.locationHelperProvider = DoubleCheck.provider(new SwitchingProvider<LocationHelper>(singletonCImpl, 16));
      this.realBluetoothScaleServiceProvider = DoubleCheck.provider(new SwitchingProvider<RealBluetoothScaleService>(singletonCImpl, 18));
      this.mockScaleServiceProvider = DoubleCheck.provider(new SwitchingProvider<MockScaleService>(singletonCImpl, 19));
      this.provideScaleServiceProvider = DoubleCheck.provider(new SwitchingProvider<ScaleService>(singletonCImpl, 17));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 6: // com.smartcbwtf.mobile.network.AuthInterceptor 
          return (T) new AuthInterceptor(singletonCImpl.defaultAuthTokenStoreProvider.get());

          case 7: // com.smartcbwtf.mobile.storage.DefaultAuthTokenStore 
          ...
          case 11: // com.smartcbwtf.mobile.utils.PermissionHelper 
          ...
          case 12: // com.smartcbwtf.mobile.repository.DefaultAuthRepository 
          return (T) new DefaultAuthRepository(singletonCImpl.provideAuthApiProvider.get(), singletonCImpl.defaultAuthTokenStoreProvider.get(), singletonCImpl.provideIoDispatcherProvider.get());

          case 13: // com.smartcbwtf.mobile.network.api.AuthApi 
          return (T) NetworkModule_ProvideAuthApiFactory.provideAuthApi(singletonCImpl.provideRetrofitProvider.get());

          case 14: // com.smartcbwtf.mobile.repository.DefaultHcfRepository 
          return (T) new DefaultHcfRepository(singletonCImpl.hcfDao(), singletonCImpl.provideHcfApiProvider.get(), singletonCImpl.provideIoDispatcherProvider.get());

          case 15: // com.smartcbwtf.mobile.network.api.HcfApi 
          return (T) NetworkModule_ProvideHcfApiFactory.provideHcfApi(singletonCImpl.provideRetrofitProvider.get());

          case 16: // com.smartcbwtf.mobile.utils.LocationHelper 
          ...
          case 17: // com.smartcbwtf.mobile.bluetooth.ScaleService 
          ...
          case 18: // com.smartcbwtf.mobile.bluetooth.RealBluetoothScaleService 
          ...
          case 19: // com.smartcbwtf.mobile.bluetooth.MockScaleService 
